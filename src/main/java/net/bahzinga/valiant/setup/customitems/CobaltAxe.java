...
public class CobaltAxe extends AxeItem {
    ...
    public CobaltAxe() {
        super(cobalt_tier, cobalt_tier.getMaxUses(), -1, new Properties().group(ItemGroup.TOOLS).maxStackSize(1).addToolType(ToolType.AXE, cobalt_tier.getHarvestLevel()).rarity(Rarity.RARE));
    }
